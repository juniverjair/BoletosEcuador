...
import (
	endpoint "BoletosEcuador/ventas/pkg/endpoint"
	http "BoletosEcuador/ventas/pkg/http"
	service "BoletosEcuador/ventas/pkg/service"
	"flag"
	"fmt"
...
var fs = flag.NewFlagSet("ventas", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "ventas")
