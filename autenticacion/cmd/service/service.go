...
import (
	endpoint "BoletosEcuador/autenticacion/pkg/endpoint"
	http "BoletosEcuador/autenticacion/pkg/http"
	service "BoletosEcuador/autenticacion/pkg/service"
	"flag"
	"fmt"
...
var fs = flag.NewFlagSet("autenticacion", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "autenticacion")
